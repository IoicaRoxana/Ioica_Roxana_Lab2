...
namespace Ioica_Roxana_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Ioica_Roxana_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Ioica_Roxana_Lab2Context context,
            ...
            foreach (var cat in context.Category)
            {
                ...
                else
                {
                    if (bookCategories.Contains(cat.ID))
                    {
                        ...
                        _ = context.Remove(courseToRemove);
                    }
                }
            }
        }
